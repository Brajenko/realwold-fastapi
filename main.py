...
from src.routes.tags.main import router as tags_router

description = """
# Implemantation of conduit backend in fastAPI

## Endpoints
[https://realworld-docs.netlify.app/specifications/backend/endpoints/](https://realworld-docs.netlify.app/specifications/backend/endpoints/)

## Responses
[https://realworld-docs.netlify.app/specifications/backend/api-response-format/](https://realworld-docs.netlify.app/specifications/backend/api-response-format/)
"""
...
tags_metadata = [
    ...
    {"name": "comments", "description": "All operations with comments to articles."},
    {"name": "favorite", "description": "Favorite article operations."},
    {
        "name": "profile",
    ...
    {
        "name": "tags",
        "description": "All operations with tags.",
    },
]

app = FastAPI(
    title="Conduit API", description=description, version="1.0.0", openapi_tags=tags_metadata
)
